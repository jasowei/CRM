...
<div class="dtree">
	<script type="text/javascript">
		...
		d.add('010202','0102','学生升级/留级','${pageContext.request.contextPath}/pages/station/listStation.jsp','','right');
		...
		d.add('0105','01','人力资源部');
		d.add('010501','0105','部门管理','${pageContext.request.contextPath}/findAllDept.action','','right');
		d.add('010502','0105','职务管理','${pageContext.request.contextPath}/findAllPost.action','','right');
		d.add('010503','0105','员工管理','${pageContext.request.contextPath}/listStaff.action','','right');
